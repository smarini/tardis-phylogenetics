...
* [Nextflow >= 20.01.0 and <= 22.10.6](https://github.com/nextflow-io/nextflow/releases/tag/v22.10.4) **Important**: Due to changes in the newer versions of Nextflow, TARDiS will not work with versions 23+.
