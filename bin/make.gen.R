...
option_list = list(
  make_option("--data.set", type="character", default="example.dataset", 
              help="dataset name"),
  make_option("--distance", type="character", default='data/example/jc.distance.precalc.csv', 
              help="genome distance matrix file, should be a csv"),
  make_option("--metadata", type="character", default='data/example/metadata.csv', 
              help="metadata file, should be a csv with the date column called Collection.date in the %d/%m/%Y format"),
  make_option("--n.cores", type="numeric", default=1, 
              help="number of cores for parallel comp."),
  make_option("--frac.new", type="numeric", default=0.14, 
              help="Fraction of random individuals"),
  make_option("--frac.evo", type="numeric", default=0.85, 
              help="Fraction of evolved individuals"),
  make_option("--frac.eli", type="numeric", default=0.01, 
              help="fraction of élite individuals"),
  make_option("--n.samples", type="numeric", default=10, 
              help="genomes per individual"),
  make_option("--gen.size", type="numeric", default=100, 
              help="population per batch"),
  make_option("--w.div", type="numeric", default=0.5, 
              help="genomic diversity weight"),
  make_option("--w.tem", type="numeric", default=0.5, 
              help="temporal distribution weight"),
  make_option("--generation", type="numeric", default=1, 
              help="generation"),
  make_option("--batch", type="numeric", default=1, 
              help="bacth"),
  make_option("--tot.batches", type="numeric", default=1, 
              help="number of overall batches per generation"),
  make_option("--dist.opt", type="character", default="max", 
