...
option_list = list(
  make_option(c("--base.dir"), type="character", default="data/example_group", 
              help="data folder for the project; will be used to generate group sub data folders"),
  make_option(c("--genome.file"), type="character", default="data/example_group.dataset", 
  ...
  make_option(c("--group.paramteres"), type="character", default='data/example_group/parametes.group.csv', 
...
for(p in 1:dim(parameters$group)[1]){
